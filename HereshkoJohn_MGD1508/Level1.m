...
-(void)didMoveToView:(SKView *)view {
    ...
    fadeOut = [SKAction fadeOutWithDuration:2.0];
...
-(void)reportScore
{
    ...
    {
        leaderScore = [[GKScore alloc] initWithLeaderboardIdentifier:leaderboardID];
        leaderScore.value = self.scoreNumber;

    } else
    {
        leaderScore = [[GKScore alloc] initWithLeaderboardIdentifier:@"KenneyLevel1Leaderboard"];
        leaderScore.value = self.scoreNumber;
